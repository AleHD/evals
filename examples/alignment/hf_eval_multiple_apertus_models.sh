...
declare -A MODEL_CHECKPOINTS=(
    ...
    # ["Apertus-8B-7.04T-it1678000--Tulu3-SFT-tulu"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_plw/apertus3-8b-sweep/chat-template/Apertus8B-tokens7.04T-it1678000-tulu-swissai-tulu-3-sft-0225/checkpoints/6d5f11d2873ecb4d/checkpoint-13446"
    # ["Apertus-8B-7.04T-it1678000--Tulu3-SFT-tulu_special_token"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_plw/apertus3-8b-sweep/chat-template/Apertus8B-tokens7.04T-it1678000-tulu_special_token-swissai-tulu-3-sft-0225/checkpoints/9b811fb20bdd09a4/checkpoint-13446"
    # ["Apertus8B-tokens7.4T-it1728000-ademamix-swissai-tulu-3-sft-0225"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_plw/apertus3-8b-sweep/token-count/Apertus8B-tokens7.4T-it1728000-ademamix-swissai-tulu-3-sft-0225/checkpoints/aba7b1a3121290e5/checkpoint-13000"
    # ["Apertus-70B-15T-it1155828--Tulu3-SFT"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_plw/apertus3-70b-sweep/Apertus70B-tokens15T-it1155828-ademamix-swissai-tulu-3-sft-0225/checkpoints/c9b2910640c220b1/checkpoint-13446"
)
